...
public class ExercicioOrientacaoBanco {
	...
	public static void exercicioConta() {
		Locale.setDefault(Locale.US);
		Scanner sc = new Scanner(System.in);
		//é obvio mas : estanciar a classe no inicio para ela ser
		//acessivel no programa e n ficar limitada
		Bank bank;
		
		System.out.print("Enter account number: ");
		int number = sc.nextInt();
		//se for usar um nextLine dps de um nextInt é necessario
		//adicionar um nextLine a mais para pegar o espaço do nextInt
		sc.nextLine();
